...
class Advantage(Window):
    ...
    async def constructor(self) -> None:
        ...
        self.set_advantage('Устойчивость к блокировкам', f'забудь о проблемах с доступом к сервисам, которые блокируют соединения через прокси или VPN. С <b>{BOT_NAME}</b> ты сможешь безпрепятственно заходить на любые платформы, где бы ты ни находился!')
